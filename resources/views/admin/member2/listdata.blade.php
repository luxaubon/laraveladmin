                        <div class="panel-body">
                            ...
                            <form class="form-inline" action="/admin/member2/index" method="GET">
 ...
 <script>
		$(document).ready(function() {
		 $("#btnCheckData").click(function (){
            ...
            window.open('/admin/member2/zip?name='+name+'&last_name='+last_name+'&phone='+phone+'&code='+code+'&date_register='+date_register+'&status='+status+'&link_image='+link_image+'&pass='+pass+'', '_blank');
