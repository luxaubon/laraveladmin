...
<div class="theme-panel theme-panel-lg">
	...
	<script>
        ...
        */
        var pieChartData = {
            labels: [<?php echo $Chart['top5dealerTitle']; ?>],
            datasets: [{
                data: [<?php echo $Chart['top5dealerData'];?>],
        ...
        var pieChartData2 = {
            labels: [<?php echo $Chart['provinceTitle']; ?>],
            datasets: [{
                data: [<?php echo $Chart['provinceData'];?>],
        ...
        var pieChartData3 = {
            labels: [<?php echo $Chart['top5companyTitle']; ?>],
            datasets: [{
                data: [<?php echo $Chart['top5companyData'];?>],
                backgroundColor: [COLOR_PURPLE_TRANSPARENT_7, COLOR_BLUE_TRANSPARENT_7, COLOR_GREEN_TRANSPARENT_7, COLOR_GREY_TRANSPARENT_7, COLOR_BLACK_TRANSPARENT_7],
                borderColor: [COLOR_PURPLE, COLOR_BLUE, COLOR_GREEN, COLOR_GREY, COLOR_BLACK],
                borderWidth: 2,
                label: 'My dataset'
        ...
        var handleMorrisBarChartTransactionMT = function () {
            Morris.Bar({
                element: 'morris-bar-chart-Transaction-mt',
                data: [
                    <?php echo $Chart['dataChartTransactionMT']; ?>
                ],
                xkey: 'device',
                ykeys: ['geekbench'],
                labels: ['ร้านค้าตัวแทนจำหน่าย'],
                barRatio: 1,
                xLabelAngle: 35,
                resize: true,
                gridLineColor: [COLOR_GREY_LIGHTER],
        ...
        var handleMorrisBarChartTransactionTT = function () {
            Morris.Bar({
                element: 'morris-bar-chart-Transaction-tt',
                data: [
                    <?php echo $Chart['dataChartTransactionTT']; ?>
                ],
                xkey: 'device',
                ykeys: ['geekbench'],
                labels: ['ร้านค้าชั้นนำ'],
                barRatio: 1,
                xLabelAngle: 35,
                resize: true,
                gridLineColor: [COLOR_GREY_LIGHTER],
        ...
        var ChartJs = function () {
            ...
            return {
                ...
                init: function () {
                    ...
                    handleMorrisBarChartTransactionMT();
                    handleMorrisBarChartTransactionTT();
                }
            };
        }();
    </script> 
