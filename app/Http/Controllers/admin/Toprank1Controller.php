...
class Toprank1Controller extends Controller
{
    //
    ...
    public function folder(){return 'toprank1';}
    ...
    public function zipFiles(Request $request){
        ...
        ");
           // dd($member);
            ...
            $filename = 'toprankLemon';
            zipfile('toprankLemon.zip',$myArrayHeaders,$myArrayData,$request->pass,$filename);
