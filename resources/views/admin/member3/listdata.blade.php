                        <div class="panel-body">
                            ...
                            <form class="form-inline" action="/admin/member3/index" method="GET">
 ...
 <script>
		$(document).ready(function() {
		 $("#btnCheckData").click(function (){
            ...
            window.open('/admin/member3/zip?name='+name+'&last_name='+last_name+'&phone='+phone+'&code='+code+'&date_register='+date_register+'&status='+status+'&link_image='+link_image+'&pass='+pass+'', '_blank');
