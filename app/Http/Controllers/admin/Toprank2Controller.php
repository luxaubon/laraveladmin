...
class Toprank2Controller extends Controller
{
    //
    ...
    public function zipFiles(Request $request){
        ...
        ");
           // dd($member);
            ...
            $filename = 'toprankOrange';
            zipfile('toprankOrange.zip',$myArrayHeaders,$myArrayData,$request->pass,$filename);
