...
class ProductsController extends Controller
{
    ...
    public function folder(){return 'products';}
    ...
    {
        $pages_id = Products::findOrFail($id);
        $pages = Products::all();
        $menu = Menus::all();
    ...
    public function del_content(Request $request){
        $page = Products::find($request->numrow);
