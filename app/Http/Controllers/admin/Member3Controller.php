...
class Member3Controller extends Controller
{
    //
    ...
    public function folder(){return 'member3';}
    ...
    public function zipFiles(Request $request){
        ...
        $filename = 'memberwrong';
        return zipfile('memberwrong.zip',$myArrayHeaders,$myArrayData,$request->pass,$filename);
