                            ...
                            <div class="tab-content m-b-0 ">
                                ...
                                <!-- Start TAP -->
                                	<div class="clearfix m-b-20">
                              		...
                              		<div class="clearfix m-b-20">
	                        				...
	                        				<div class="col-sm-12">
				                            <textarea class="form-control" id="name_th" name="name_th" rows="2" data-parsley-range="[1,200]" placeholder="Title, Header.." data-parsley-required="true">{{ old('name_th') }}</textarea>
                                ...
                                <div class="clearfix m-b-20">
                              		...
                              		<div class="clearfix m-b-20">
	                        				<label class="control-label col-sm-2" for="title">Title</label>
	                        				<div class="col-sm-12">
				                            <textarea class="form-control" id="name_en" name="name_en" rows="2" data-parsley-range="[1,200]" placeholder="Title, Header.." data-parsley-required="true">{{ old('name_en') }}</textarea>
	                                ...
	                                <div id="collapse1" class="panel-collapse collapse show">
										...
										<select class="form-control" id="parent_id" name="parent_id" >
											...
											@foreach ($mainmenu as $db)
												<option class="text-danger-light" value="{{$db->id}}" >{{json_decode($db->name)[0]->name_th}}</option>
											@endforeach
